...
{#if scrollY > 0}
	<nav
		class="z-10 shadow-lg shadow-black/40 fixed top-0 left-0 right-0 py-4 xl:px-40 lg:px-20 px-10 text-white flex text-2xl bg-blue-zodiac"
	>
		<a class="mr-auto" href="/" aria-label="Home">
			<svg 
			 class="w-16 fill-pastel-blue" viewBox="0 0 90 46">
				<path
...
{:else}
	<nav
		class="fixed top-0 left-0 right-0 py-4 xl:px-40 lg:px-20 px-10 text-white flex text-2xl bg-blue-zodiac"
	>
